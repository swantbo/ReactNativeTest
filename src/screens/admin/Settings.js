		...
		<>
			<ScrollView style={styles.settingsContainer}>
				<Card containerStyle={styles.pointsCard}>
					<Avatar containerStyle={styles.avatarBackground} rounded size='large' title={changeName?.[0]} source={{uri: changeBarberImage}} onPress={() => pickImage()} />
