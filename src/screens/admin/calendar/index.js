...
const AdminCalendarScreen = ({ navigation }) => {
  ...
  const splitHours = async (selectedDate) => {
    const weekDay = Promise.resolve(
      moment(selectedDate, "YYYY-MM-DD HH:mm:ss").format("dddd").toString()
    );
                ...
                <ListItem.Swipeable
                  ...
                  leftContent={
                    ...
                    key.name !== "Off" && (
                      <Button
                        title={
                          key.strikes ? "Strikes: " + key.strikes : "Add Strike"
                        }
                        icon={{
                          name: "add-circle",
                          color: "white",
                          ...
                          Alert.alert(
                            ...
                            [
                              ...
                              },
                              {
                                text: "Add Strike",
                                onPress: () =>
                                  addStrike(key.userId, key.strikes),
                              },
                            ]
                          )
                        }
                  ...
                  onPress={() =>
                    !key.name
                      ? navigation.navigate("AdminAddAppointmentScreen", {
                          formattedDate,
                          time: [`${key.time}`],
                        })
                      : key.name === "Off"
                      ...
                      {key.name ? (
                        <>
                          ...
                          >
                            <ListItem.Subtitle style={styles.text}>
                              Goat Points:{" "}
                              {key.goatPoints ? key.goatPoints : "0"}
                            </ListItem.Subtitle>
                          </View>
                        </>
                      ) : null}
