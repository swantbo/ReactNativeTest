...
import {View, Text, ScrollView, Linking, ActivityIndicator, SafeAreaView, ImageBackground, TouchableOpacity, FlatList} from 'react-native'
		...
		<>
			...
			<View style={styles.container}>
				<FlatList
					...
					renderItem={({item}) => (
						<Card containerStyle={styles.barberAddress}>
							<Card.Title style={{alignSelf: 'flex-start', color: '#E8BD70'}}>Photos</Card.Title>
